...
set_str type_source_email  			"data_mailver"
...
set_num_rnd choose_app_random 1 2
 ...
 if cmp [choose_app_random] "1"
	 toast "KuBet"
	 set_str app_name           		"pub:Tech spice"
	 set_str key_search_app             "pub:Tech spice"
	 set_str key_compare_chplay          "KUBET | Question Math"
	 set_str key_compare_chplay_2         "KUBET | Question Math"
 end_if
...
while chk_limit 60
	if chk_text "phone number to get" 0
		...
		delay_sec_rnd 2 3
		while chk_limit 10
		if chk_text "Enter code" 0 
			delay_sec_rnd 1 2
			toast "Enter code"
			touch_text "Enter code" 1
			delay_sec_rnd 1 2			
